...
\begin{frame}
\frametitle{De-truing Experimental Results}
\begin{figure}
        \centering
        \begin{subfigure}[b]{0.45\textwidth}
...
\begin{itemize}
    \item Random spoke displacement vector, $\bf d$,  generated
    \item Spokes adjusted using lateral feedback by $\bf d$
    \item Final wheel measurements vs experimental prediction shown
\end{itemize}
\end{frame}
