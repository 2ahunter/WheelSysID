...
images = ReadMultipleImages('../data/ztr_final/val_32_10/*.JPG','IMG')

# Load the reference image
ref_img = cv2.imread('../data/ztr_final/val_32_10/cal/ref.JPG',0)
im = cv2.resize(ref_img, (0,0), fx=0.3, fy=0.3) 
# cv2.imwrite('ref.png',im)

# Load the zero angle calibration image
zero_img = cv2.imread('../data/ztr_final/val_32_10/cal/zero.JPG',0)
...
plt.legend()
data = [Lateral,Radial]
sio.savemat('./Matlab scripts/valid_32_10.mat',mdict={'data_LR':data})